...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-muted/60 py-12 px-4 text-foreground md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <Link
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full bg-background text-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
              >
          ...
          {/* Skills */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">{footerT("skillsTitle")}</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">{footerT("quickLinksTitle")}</h3>
            <ul className="space-y-3">
              <li>
              ...
              <li>
                <Link href="/courses" className="text-sm text-muted-foreground transition-colors hover:text-primary">
                  {footerT("quickLinks.courses")}
                </Link>
              </li>
              <li>
                <Link href="/learning-paths" className="text-sm text-muted-foreground transition-colors hover:text-primary">
          ...
          {/* Blog Gallery */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">{footerT("latestPostsTitle")}</h3>
                ...
                blogs.slice(0, 6).map((blog: Blog) => {
                  ...
                  return (
                    <Link
                      key={blog.id}
                      href={`/blog/${blogSlug}`}
                      className="aspect-square overflow-hidden rounded border border-border bg-background transition-colors hover:border-primary"
                    >
                      {blogImageUrl ? (
                        <Image
                          src={blogImageUrl}
        ...
        <div className="border-t border-border pt-6">
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <span className="font-medium text-foreground">TechHub</span> ||{" "}
